...
SELECT dish.name AS dish_name, categories_dishes.price AS price, categories_dishes.category_id AS category
FROM dish
...
SELECT dish.name AS spicy_dish_name, categories_dishes.category_id AS category, categories_dishes.price AS price
FROM dish
JOIN categories_dishes
ON dish.id = categories_dishes.dish_id
